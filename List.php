        ...
        <div class="container-xxl position-relative p-0">
            ...
            <div class="container-xxl py-5 bg-dark hero-header mb-5">
                <div class="container text-center my-5 pb-4">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">รายการสั่งซื้อ</h1>
                </div>
            </div>
        </div>
        <!-- Navbar & Hero End -->
        ...
        <div class="table-responsive">
            <table class="table text-start align-middle table-bordered table-hover mb-0">
                ...
                <tbody>
                    <?php
                        $user = $data['user'];
                        $sql2 = "SELECT * FROM orders WHERE user = '$user' ";
                    ...
                    <tr>
                        ...
                        <td><a class="btn btn-sm btn-info" href="user/money.php">จ่ายเงิน</a></td>
                        <td><a class="btn btn-sm btn-info" href="user/receipt.php?sarea_id=<?php echo $data2['order_ID'] ?>">ใบเสร็จ</a></td>
                        <td><a class="btn btn-sm btn-danger" href="user/proDeleteOrders.php?sarea_id=<?php echo $data2['order_ID'] ?>">ลบ</a></td>
                    </tr>
                    <?php
                        }
                    ?>
