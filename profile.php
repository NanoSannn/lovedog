...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="main text-center" >
            <div class="">
                <div class="container border border-dark  bg-light text-center" style="margin-top: 20px;">
                    <table align="center">
                        <tbody>
                            <tr>
                    ...
                    <br>
                    <button type="submit">
                        <a href="ctrProfile.php">
                            <i class="fa fa-pen fa-xs edit">แก้ไขข้อมูลสมาชิก</i>
                        </a>
                    </button>
                    <br>
                </div>
