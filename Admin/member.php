                    ...
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                ?>
                                <tr>
                                    <td><?php echo $data2['member_ID'] ?></td>
                                    <td><?php echo $data2['user'] ?></td>
                                    <td><?php echo $data2['Tal'] ?></td>
                                    <td><?php echo $data2['mail'] ?></td>
                                    <td>
                                        <?php 
                                            if($data2['role_ID']==1){
                                    ...
                                    <td><?php echo $data2['Edit_MODIFY'] ?></td>
                                    <td><a class="btn btn-sm btn-danger" href="member/proDeleteMember.php?sarea_id=<?php echo $data2['member_ID'] ?>">ลบ</a></td>
                                </tr>
                                <?php
                                    }
                                ?>
