            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">พันธุ์ ชิวาวา</h6>
                        <a href="Product/AddProduct.php">เพิ่มสินค้า</a>
                    </div>
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                <?php
                                    $sql2 = "SELECT * FROM products WHERE details1 = 2";
                                ...
                                <tr>
                                    ...
                                    <td><a class="btn btn-sm btn-primary" href="Product/EditProduct.php?sarea_id=<?php echo $data2['Products_ID'] ?>">แก้ไข</a></td>
                                    <td><a class="btn btn-sm btn-danger" href="Product/proDeleteProduct.php?sarea_id=<?php echo $data2['Products_ID'] ?>">ลบ</a></td>
                                </tr>
                                <?php
                                    }
                                ?>
