                ...
                <div class="row g-4">
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            <i class="fa bi-person fa-3x text-primary"></i>
                            <div class="ms-3">
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2">ยอดขายรวม</p>
                                <?php
                                $conn4 = mysqli_connect($serverName, $uesrName, $passwordserver, $datebase);
                                ...
                                if ($result4->num_rows > 0) {
                                    ...
                                    while($row = $result4->fetch_assoc()) {
                                        $total += $row['Products_price'];
                                    }
                                ?>
                                        <h6 class="mb-0">฿<?php echo number_format($total, 0 ) ?></h6>
                                <?php
                                } else {
                                }
                                ?>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">ตรวจสอบการจ่ายเงิน</h6>
                    </div>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
                                <tr class="text-dark">
                                    ...
                                    <th scope="col">ตรวจสอบการจ่ายเงิน</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                    $sql5 = "SELECT * FROM orders WHERE Status_order = 1";
                                    $result5 = mysqli_query($conn, $sql5);
                                    while($data5 = mysqli_fetch_array($result5)){
                                ?>
                                <tr>
                                    <td><?php echo $data5['order_ID'] ?></td>
                                    <td><?php echo $data5['Products_ID'] ?></td>
                                    <td><?php echo number_format($data5['Products_price'], 0 ) ?></td>
                                    <td><?php echo $data5['user'] ?></td>
                                    <td><?php echo $data5['DATE_MODIFY'] ?></td>
                                    <td><?php 
                                        if($data5['Status_order']==1){
                                            echo "รอชำระเงิน";
                                        }else{
                                            echo "ชำระเงินแล้ว";
                                        }
                                    ?></td>
                                    <td><a class="btn btn-sm btn-primary" href="orders/proOrders.php?sarea_id=<?php echo $data5['order_ID'] ?>">ยืนยันการชำระเงิน</a></td>
                                </tr>
                                <?php
                                    }
                                ?>
