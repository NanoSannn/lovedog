...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl position-relative p-0">
            ...
            <div class="container-xxl py-5 bg-dark hero-header mb-5">
                <div class="container text-center my-5 pb-4">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">ข้อมูลส่วนตัว</h1>
                </div>
            </div>
        </div>
        <!-- Navbar & Hero End -->
        ...
        <!-- Main -->
        <form action="prcProfile.php" method="post">
        <div class="main text-center" >
            <div class="">
                <table align="center">
                    <tbody>
                        <tr>
                            <td align="left">ชื่อสมาชิก</td>
                            <td>:</td>
                            <td>
                                <input type="text" name="user" required value="<?php echo $data['user']; ?>" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <input type="text" name="member_name" required value="<?php echo $data['member_name']; ?>" />
                            </td>
                        </tr>
                        <tr>
                            <td align="left">เมล</td>
                            <td>:</td>
                            <td>
                                <input type="text" name="mail" required value="<?php echo $data['mail']; ?>" />
                            </td>
                        </tr>
                        <tr>
                            <td align="left">เบอร์</td>
                            <td>:</td>
                            <td>
                                <input type="text" name="Tal" required value="<?php echo $data['Tal']; ?>" />
                            </td>
                        </tr>
                    </tbody>
                </table>
            </div>
            <button type="submit" class="btn btn-primary"><i class="bi bi-download">บันทึกข้อมูล</i></button>
        </div>
        </form>
        <!-- End -->
        <!-- Back to Top -->
