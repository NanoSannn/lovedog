    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl position-relative p-0">
            ...
            <div class="container-xxl py-5 bg-dark hero-header mb-5">
                <div class="container text-center my-5  pb-4">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">พันธุ์ ปอม</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            <li class="breadcrumb-item"><a href="#">หน้าหลัก</a></li>
                            <li class="breadcrumb-item"><a href="#">หน้า</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">ปอม</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container-xxl  pb-3">
            <div class="container">
                <div class="row g-4">
                    <?php
                        $sql1 = "SELECT * FROM products WHERE details1 = 1";
