    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="text-center">
            <table class="table table-primary">
                <tr>
                    <h2>ธนาคาร กรุงไทย</h2>
                    <h5>192-9-12828-2</h5>
                </tr>
                <tr>
                    <h2>สแกน QR จ่ายเงิน</h2>
                    <img src="../img/QR.png" style="width:300px;height:300px;">
                </tr><br>
                <tr>
                    <a href="#">
                        <button type="submit" class="btn btn-primary">ส่งเอกสารการจ่ายเงิน</button>
                    </a>
                </tr>
            </table>
        </div>
